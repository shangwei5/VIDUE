...
parser.add_argument('--videos_src_path', type=str, default='/home/sw/sw/dataset/Event-data/GOPRO_large_all/test/images', help='the dir of high-frame-rate video')
parser.add_argument('--videos_save_path', type=str, default='/home/sw/sw/dataset/Event-data/GOPRO_large_all/LFR_Gopro_97', help='the dir of low-frame-rate video')
parser.add_argument('--num_compose', type=int, default=9, help='how many frames to compose a blurry frame')
parser.add_argument('--tot_inter_frame', type=int, default=16, help='the down sample rate')
