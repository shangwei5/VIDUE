...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_outputs', type=int, default=16,
                        help="For Kx FLAVR, use n_outputs k-1")
    args = parser.parse_args()

    if args.default_data == 'GOPRO':
        args.data_path = '/home/sw/sw/dataset/Event-data/GOPRO_large_all/LFR_Gopro_97'
        args.gt_path = '/home/sw/sw/dataset/Event-data/GOPRO_large_all/test/images'
        args.model_path = '../experiment/VIDUE_GoPro16x/model_best.pt'
        args.result_path = '../infer_results/VIDUE_GoPro16x_97'
        args.n_sequence = 4
        args.n_GPUs = 1
